  ...
  return (
    <div name='home' className='w-full h-screen bg-[black]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='font-bold text-xl text-orange-600'>Hi &#128075;&#127996; , I'am,</p>
        <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>
          PANDU RANGA AVINASH <p className='text-4xl sm:text-7xl text-orange-600'>SRIKHAKOLLU</p>
        </h1>
        ...
        <p className='py-8 text-xl font-bold text-orange-600'>Tech Stack</p>
